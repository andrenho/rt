foreach (TARGET ${FINAL_TARGETS})
    ...
    add_custom_target(
            ${TARGET}-leaks
            COMMAND ${CMAKE_COMMAND} -E env VALGRIND=1 valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes --track-fds=yes --suppressions=${CMAKE_SOURCE_DIR}/${BASE_DIR}/cmake/valgrind.supp -- ./${TARGET}
            DEPENDS ${TARGET}
