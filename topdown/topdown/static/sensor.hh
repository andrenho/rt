...
public:
    Sensor(class World const& world, std::vector<geo::Shape> const& shapes, std::optional<SensorModifier> const& sensor_modifier={})
            : StaticObject(world, shapes, true), sensor_modifier_(sensor_modifier) {}
    Sensor(class World const& world, geo::Shape const& shape, std::optional<SensorModifier> const& sensor_modifier={})
            : Sensor(world, std::vector<geo::Shape> { shape }, sensor_modifier) {}
